...
public class ApplicationConfig extends Application {
    ...
    private void addRestResourceClasses(Set<Class<?>> resources) {
        ...
        resources.add(DrPlant.service.PlagueFacadeREST.class);
        resources.add(DrPlant.service.PlantFacadeREST.class);
        resources.add(DrPlant.service.ShopFacadeREST.class);
